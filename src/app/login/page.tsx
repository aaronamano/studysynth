        ...
        <Card className="w-full max-w-sm bg-black/60 backdrop-blur-md border-purple-500/20 shadow-lg shadow-purple-500/5">
          <CardHeader className="space-y-1">
            <div className="flex flex-col items-start space-y-2">
              ...
              <CardTitle className="text-2xl font-bold bg-linear-to-r from-purple-600 via-violet-600 to-indigo-600 text-transparent bg-clip-text">Login</CardTitle>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col">
              <Button type="submit" className="w-full bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white mt-4">Sign in</Button>
