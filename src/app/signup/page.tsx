    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="flex items-center justify-center min-h-screen relative z-10">
        ...
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold bg-linear-to-r from-purple-600 via-violet-600 to-indigo-600 text-transparent bg-clip-text">Sign Up</CardTitle>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col">
            <Button type="submit" className="w-full bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white mt-4">Sign up</Button>
